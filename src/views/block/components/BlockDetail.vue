  ...
  <div>
    <div v-if="isCreate">
      ...
      >
        <el-form-item label="服务名称">
          <el-input v-model="postForm.metadata.name" placeholder="唯一标识一个服务，不可更改，小写字母、数字、半角点与横杆"></el-input>
        </el-form-item>
    ...
    <div v-if="isEdit" class="components-container">
      <div class="editor-container">
        <el-button type="primary" @click="updateForm" style="margin: 0 0 20px 0">保存</el-button>
